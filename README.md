...
GNPS2 to SNAP-MS Bridge on shinyapps.io
...
Simply clone this repository and run the app. The server logic is configured to handle large .graphml files up to 500 MB. Once processed, the app provides a convenient download button for the fixed GraphML file.

🧑‍🔬 About & Contact
This project is developed by Alan Hernandez. The application is proudly associated with the Microbial Natural Products Research Lab. 125, School of Chemistry, UNAM.
